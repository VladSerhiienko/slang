...
class SlangConan(ConanFile):
    ...
    def generate(self):
        # The Emscripten platform toolchain is chained via the
        # tools.cmake.cmaketoolchain:user_toolchain conf (passed by the build driver),
        # which CMakeToolchain picks up automatically.
